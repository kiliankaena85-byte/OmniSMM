/**
 * Robokassa Multi-Tenant Webhook Request Handler
 * Shared between root route (/api/webhooks/robokassa) and parameterized route (/api/webhooks/robokassa/[tenantId]).
...
export async function handleRobokassaWebhookRequest(
  req: NextRequest,
