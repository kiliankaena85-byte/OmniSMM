...
import { Link as LinkIcon, X, AlertTriangle, CheckCircle2 } from 'lucide-react';
import { PublicNetwork, PublicService } from '@/actions/order/catalog';

export interface PlanCheckoutLinkProps {
  url: string;
...
export function PlanCheckoutLink({
  ...
  const placeholder = selectedService.linkPlaceholder ||
