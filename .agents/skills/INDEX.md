...
| [**`bank-grade-db-guard`**](./bank-grade-db-guard/SKILL.md) | Кластер 2 (Distributed & Concurrency) | Стандарт банковской надежности: Ledger-First, ExactMath BigInt, Stripe-Style Idempotency Vault, партиционирование, Outbox SKIP LOCKED, ретрай 40P01, карантин | База данных, банковская надежность, Ledger-First, идемпотентность, дедлоки, 40P01, 40001, партиционирование, Outbox, SKIP LOCKED, карантин, PgBouncer | `src/services/financial/wallet-ops.ts`, `src/lib/transactions.ts`, `.agents/skills/bank-grade-db-guard/SKILL.md` | `concurrency-acid-guard`, `db-evolution-zero-downtime`, `event-driven-reliability` |
