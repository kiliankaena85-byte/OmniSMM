...
description: >
  Архитектурный стандарт юридической безопасности, приватности оператора (152-ФЗ),
  электронной торговли (ст. 437 ГК РФ, ст. 9 ЗоЗПП, Постановление Правительства РФ № 2463)
  и стратегии Brand-First Deep Legal Privacy в платформе OmniSMM 1.0.
  Используй этот скилл ВСЕГДА при редактировании: футеров (MegaFooter, FluxCyberFooter),
  юридических страниц (/legal/*, LegalPageContent), публичных оферт, реквизитов компании,
  настроек контактов тенанта, политики конфиденциальности и экранов ожидания.
---
