...
4. **Tenant Isolation:** SMMplan (`smmplan.pro`) строго в Classic B2B Slate/Sky; SMMflux (`smmflux.ru`) строго в Radiant Aurora / Obsidian. Запрещено смешивать токены брендов.
