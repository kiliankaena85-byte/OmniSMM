...
description: >
  Аналитический и операционный скилл сквозного автоматического импорта, интеллектуальной классификации
  и многофакторной сортировки услуг от внешних SMM-провайдеров в платформе OmniSMM 1.0 (SMMplan / SMMflux).
  Используй этот скилл ВСЕГДА, когда подключается новый провайдер, требуется пакетный импорт сотен услуг,
  систематизация каталога по социальным сетям и категориям, нормализация названий (AI-рерайтинг с бейджами),
  применение Human-in-the-Loop шлюза при сомнениях ИИ, а также расчет адаптивных розничных цен по формулам
  платформы с защитным порогом 3.0x.
---
